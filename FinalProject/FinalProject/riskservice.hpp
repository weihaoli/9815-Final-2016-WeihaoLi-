...
public:
  ...
  friend ostream& operator << (ostream& os, const PV01<T>& t) {
	  os << "  Product: " << t.GetProducts() << 
	   "    Quantity: " << t.GetQuantity() << 
	   "    Total Risk: " << t.GetPV01() << endl;
	  return os;
  }
